...
<div class="section-comments">
      ...
      <div class="reveal xssmall" id="comment-modal" style="display:block;"><!-- блок для контента модального окна -->
        ...
        <div class="reveal-body"><!-- Содержимое окна, управляющие элементы -->      
          <div class="add-product-form-wrapper">
             <label><span class="custom-text"><?php echo $lang['COMMENTS_URL']; ?>:</span>
               <a style="margin-left:17px;" target="_blank" class='commentUrl' href="<?php echo SITE?>/" data-site="<?php echo SITE?>" title="<?php echo $lang['T_TIP_COMMENTS_URL']; ?>"><?php echo SITE?>/</a></label>
         		<label><span class="custom-text"><?php echo $lang['COMMENTS_NAME']; ?>:</span>
         		<input type="text" name="name" value="" class="product-name-input tool-tip-right" title="<?php echo $lang['T_TIP_COMMENTS_NAME'];?>"></label>
         		<label><span class="custom-text"><?php echo $lang['COMMENTS_EMAIL']; ?>:</span>
         		<input type="text" name="email" value="" class="product-name-input tool-tip-right" title="<?php echo $lang['T_TIP_COMMENTS_EMAIL'];?>"></label>
         		<label><span class="custom-text"><?php echo $lang['COMMENTS_APPROVE']; ?>:</span>
         		<select class="last-items-dropdown tool-tip-right" title="<?php echo $lang['T_TIP_COMMENTS_STATUS'];?>">
         			<option value="0"><?php echo $lang['COMMENTS_APPROVE_NO']; ?></option>
         			<option value="1"><?php echo $lang['COMMENTS_APPROVE_YES']; ?></option>
         		</select></label>
         		<label><span class="custom-text"><?php echo $lang['COMMENTS']; ?>:</span>
         		<textarea name="comment" class="product-desc-field" title="<?php echo $lang['T_TIP_COMMENTS_COMMENT'];?>"></textarea></label>
            <label class="img-label"><span class="custom-text"><?php echo $lang['IMG']; ?>:</span>
    ...
    <div class="widget-table-body">
      ...
      <div class="widget-table-action base-settings" style="display:none;">
        <h3><?php echo $lang['OPTIONS']; ?></h3>
        <div class="large-6 small-12 columns">
          <div class="row">
            <div class="large-6 columns">
              <span><?php echo $lang['ENABLE_IMG']; ?>:</span>
            </div>
          ...
          <div class="row">
            <div class="large-6 columns">
              <span><?php echo $lang['MAX_WIDTH_IMG']; ?> (px):</span>
            </div>
            <div class="large-6 columns">
              <input type="number" name="maxWidth" value="<?php echo $options['maxWidth']; ?>">
            </div>
          </div>
          <div class="row">
            <div class="large-6 columns">
              <span><?php echo $lang['MAX_HEIGHT_IMG']; ?> (px):</span>
            </div>
            <div class="large-6 columns">
              <input type="number" name="maxHeight" value="<?php echo $options['maxHeight']; ?>">
            </div>
          </div>
          <div class="row">
            <div class="large-6 columns">
              <span><?php echo $lang['MAX_WIDTH_PRE']; ?> (px):</span>
            </div>
            <div class="large-6 columns">
              <input type="number" name="maxWidthThumb" value="<?php echo $options['maxWidthThumb']; ?>">
            </div>
          </div>
          <div class="row">
            <div class="large-6 columns">
              <span><?php echo $lang['MAX_HEIGHT_PRE']; ?> (px):</span>
            </div>
            <div class="large-6 columns">
              <input type="number" name="maxHeightThumb" value="<?php echo $options['maxHeightThumb']; ?>">
            </div>
          </div>
          <div class="row">
            <div class="large-6 columns">
            ...
            <div class="large-6 columns">
              <button class="base-setting-save button success"><span><i class="fa fa-floppy-o"></i> <?php echo $lang['SAVE']; ?></span></button>
            </div>
          </div>
        </div>    
        <div class="clear"></div>
        ...
        <table class="widget-table product-table main-table" style="width:100%; " >
          ...
          <tbody class="comments-tbody">
          	...
          	<tr id = "<?php echo $comment['id']; ?>">
	          	...
	          	<td class="c-approved"><?php echo $comment['approved'] ? '<span class="approved-comment">'.$lang['COMMENTS_APPROVE_YES'].'</span>' : '<span class="n-approved-comment">'.$lang['COMMENTS_APPROVE_NO'].'</span>'; ?></td>
	          	<td class="actions">
